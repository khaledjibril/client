    ...
    <>
      ...
      >
        <div className="flex items-center justify-between">
          <p className="text-text-foreground text-[2rem] font-bold leading-7 sm:leading-0">
            Payment Information
          </p>
          <button
            onClick={onClick}
            type="button"
            className="btn-close-payment-info p-4 border border-primary rounded-lg cursor-pointer"
          >
            <IoMdClose className="text-primary" />
          </button>
        </div>
        <p class="text-muted-foreground text-[1.4rem] mt-1 leading-5 sm:leading-0">
