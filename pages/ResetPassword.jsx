...
const ResetPassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch("https://photography-server-catq.onrender.com/api/auth/reset-password", {
        method: "POST",
          ...
          <div className="flex flex-col items-center justify-center w-200 mx-6 rounded-lg bg-[#f7f7e3] shadow-xl border border-[#ddddb5]">
            ...
            <div className="p-[2.4rem] pt-0 w-full">
              ...
              <form className="space-y-6 w-full" onSubmit={handleSubmit}>
                ...
                {/* Confirm Password */}
                <div className="mb-6">
                  <label htmlFor="confirmPassword" className="capitalize text-[#504230] font-medium">
                    Confirm Password
                  </label>
                  <input
                    type="password"
